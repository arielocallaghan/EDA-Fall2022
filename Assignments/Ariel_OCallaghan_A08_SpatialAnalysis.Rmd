...
> ANSWER:
> dec_lat_va (x values) and dec_long_va (y values). Coordinate system is NAD83
...
>ANSWER: 
> The coord_acy_cd, geometry was created and the field dec_long_va, coord_acy_cd disapeared
...
ggplot() +
  ...
  geom_sf(data = Gage_Loc_df, color = 'Blue') +
  labs(title = "NWIS Gage Locations in Nebraska", 
       subtitle = "Ariel O'Callaghan")
...
mapview(NE_Counties_Sf, col.regions = "Green", alpha=0.25) +
  mapview(Loc_Flow_Together, zcol = "gage_ht") 
...
mapview(Gage_Loc_UTM, col.regions = "Blue") +
...
#24 Plot
mapview(NE_Counties_Sf, col.regions = "Light Blue", alpha=0.5) + 
