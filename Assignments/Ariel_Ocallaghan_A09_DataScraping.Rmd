...
#Durham__ashville_plot<-ggplot(durham_asheville,)+
 # geom_line(aes(x=Date,y=max.withdrawals.mgd, color=water.system.name))
...
#Durham_asheville_2015<-ggplot(durham_asheville,(aesx=Date, y=max.withdrawals.mgd))+
...
#Ashvile_Durham_plot_9<-ggplot(Ash_Together,aesx=Date,y=max.withdrawals.mgd) +
#geom_line() +
