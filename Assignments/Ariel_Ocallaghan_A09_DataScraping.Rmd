...
Durham_2015_plot<-ggplot(df_durham_2015,aes(x=Date,y=max.withdrawals.mgd, group=1)) +
  geom_line()+
...
durham_asheville<- rbind.data.frame(df_Asheville_2015, df_durham_2015)
...
Durham_asheville_2015<-ggplot(durham_asheville, aes(x = Date,y = max.withdrawals.mgd)) +
  geom_line(color=water.system.name) +
  #labs(title = paste("Durham and Asheville Water Wtihdrawl"), X = "Date", y = " Max Daily Withdrawals (mgd)")
#print(Durham_asheville_2015)

###TEST
#Durham_asheville_2015.2<-ggplot(df_durham_2015,aes(x = Date,y = max.withdrawals.mgd))+
  ggplot(df_Asheville_2015) +
  geom_line(color=water.system.name) +
  labs(title = paste("Durham and Asheville Water Wtihdrawl"), X = "Date", y = " Max Daily Withdrawals (mgd)")
#print(Durham_asheville_2015.2)
...
Ashvile_Durham_plot_9<-ggplot(Ash_Together,aes(x=Date,y=max.withdrawals.mgd)) +
geom_line() +
labs( X = "Date", y = " Max Withdrawls (MGM)")
print(Ashvile_Durham_plot_9)


ggplot(Ash_Together,aes(x=Date,y=max.withdrawals.mgd)) +
geom_line(color = water.system.name) +
...
Asheville uses more water over time. 
