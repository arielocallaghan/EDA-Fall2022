...
epa.o3.2018.data <- read.csv("./Data/Raw/EPAair_O3_NC2019_raw.csv", stringsAsFactors = TRUE)

setwd("~/R/EDA-Fall2022")
epa.o3.2019.data <- read.csv("./Data/Raw/EpAair_O3_NC2018_raw.csv", stringsAsFactors = TRUE)

epa.PM25.2018.data <- read.csv("./Data/Raw/EpAair_PM25_NC2018.raw.csv", stringsAsFactors = TRUE)
epa.PM25.2019.data <- read.csv("./Data/Raw/EpAair_PM25_NC2019.raw.csv", stringsAsFactors = TRUE)
```
