...
> Answer:
The most common are Honey Bee, Parasitic Wasp, Buff Tailed Bumblebee, Carniolan Honey Bee, Bumble Bee, and Italian Honeybee. 
...
> Answer:The  class(Neonics.data$Conc.1..Author.) shows up as "factor" because XXXXXXXXX
...
Litter.data.datetime <- as.Date.factor(Litter.data$collectDate, format= "%Y/%m/%d")
...
```{r}
#help("unique")
unique(Litter.data, aes(x=Niwot Ridge))
```
