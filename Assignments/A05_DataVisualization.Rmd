...
#2 
#capital "Y" and lowercase "y" mean different things. In this case the year was fully written out "2018" so you needed to use capital "Y". The use of lowercase "y" tells your code the last two digits of the year are given so it would incorrectly interpret the year to be "20" thus 2020 instead of 2018.
#A quick way to change the entire contents of a column is by doing dataframe$column <- "value" 
