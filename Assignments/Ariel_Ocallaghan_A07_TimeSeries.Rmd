...
GOinterpolate<-
  GraninerOzone%>%
  mutate(Ozone_Cnx = zoo::na.approx(Daily.Max.8.hour.Ozone.Concentration))
...
```{r}
#9 
#create to new columns one named month-year showing fist day of each month. second column with mean of ozone each month. demisnions ill have fewwer rows then the previous columns. 
