...
#Set the URL
theURL <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=7&format=rdb'
...
# same code but with new site lab exercises

#Set the URL
theURL2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02087500&period=24&format=rdb'

#Get the data, which starts on line 30
gage_data_2 <- read.table(theURL,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T) 
...
#tags - basic-table-a or td:nth-child(1), td:nth-child(2), 
...
big_df <- map(seq(2015,2018), scrape.it)
