...
#Create a map
mapview(huc8_sf, col.region= 'orange', alpha.regions=0.5) +
  mapview(huc8_sf2, col.region= 'purple', alpha.regions=1)
...
Enviro.atlas<-read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv' , colClasses = c(HUC_12= 'factor'))%>% 
