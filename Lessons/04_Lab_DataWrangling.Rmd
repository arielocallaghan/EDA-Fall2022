...
NTL.phys.data.1990-1999<-filter()
#teacher output
NTL.phys.data.Ex2 <-filter(NTL.phys.data,lakename =="Tuesday Lake" & year4>=1990 & year4 <=1999)
...
NTL.phys.data.Ex3 <- %>% 
  filter(lakename == "Tuesday Lake" & year4>=1990 & year4<=199 & month(sampledate) ==7)
