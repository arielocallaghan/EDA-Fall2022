...
```{r, fig.height = 3, fig.width = 4}
#historgrams counts by value interval. Apply with numeric coumn. 
...
#geom_histogram f1 got help. to explain bin and binwidth. Usually use between 5-20 bins per jon recording. 
#want to make sure bins show story of data
ggplot(USGS.flow.data) +
...
```{r, fig.height = 3, fig.width = 4}
# categorical and numeric data, lookin at distribution
ggplot(USGS.flow.data) +
  geom_boxplot(aes(x = gage.height.mean.approval, y = gage.height.mean))

#low values of guage high tight distribution of disharge values. 
#shows variance across distribution
#analysis to histogram looking at distribution along slice of data
ggplot(USGS.flow.data) +
